            ...
            <div className="p-4 bg-yellow-50 border-t border-yellow-200 text-yellow-800 flex items-start gap-3">
              ...
              <div>
                ...
                <div className="text-xs text-gray-500 mt-1">
                  The server returned a problem while creating or uploading the PDF. Please try generating notes again. You may still download the notes as a text file above, or check the server logs for details.
                </div>
              </div>
            </div>
          )}
